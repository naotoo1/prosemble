"""
Implementation of Kmeans++ Alternative Optimisation Algorithm
"""
...
class kmeans_plusplus:
    ...
    def _get_sample_max_prob_margin(self):
        sample_index = np.argmax([
            get_distance(sample, self._get_random_initial_prototype())
    ...
    def not_nearest_centroids(samples, centroid):
        try:
            distance = [get_distance(sample, centroid) for sample in samples]
