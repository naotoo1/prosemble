...
Below is a simulation of the technique with the iris data set using the ```test_wdbc.py``` based on transfered tranfered pre-trained model prototypes from ```SLVQ```,```RSLVQ```, ```LGMLVQ```
